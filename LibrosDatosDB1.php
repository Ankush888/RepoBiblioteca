<?php
    ...
    if ($limite > 0) {
        ...
        echo        "<input type='button' value='Pagina Anterior' onclick=\"cargarlibros1(" . $limit . ")\" name='botonLogout' id='signin' class='form-submit' style='margin-top: 0px; margin-left: 0px; padding: 8px 20px;'/>";
        echo    "</div>";
        echo "</fieldset>";
    ...
    if ($limite < $total - 3) {
        ...
        echo    "<div class='form-group form-button'>";
        echo        "<input type='button' value='Pagina Siguente' onclick=\"cargarlibros1(" . $limit . ")\" name='botonLogout' id='signin' class='form-submit' style='margin-top: 0px; margin-left: 0px; padding: 8px 20px;'/>";
        echo    "</div>";
        echo "</fieldset>";
