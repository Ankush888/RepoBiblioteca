...
<html>
    <head>
        <meta charset="UTF-8">
        <title> Eliminar Libro - BookHouse</title>
...
#tdMedia {
	...
	<div class="container" style="width: 800px; margin-top: 1%;">
		<div class="itemsGeneros-head">
			<p>Lista de Todos los Libros para Eliminar:</p>
			<hr>
		</div>
		<br>
		...
		<p
			...
			<strong> Para Eliminar un libro Intrduzca el mismo idLibro del libro
				a eliminar que aparece en la lista de Libros</strong>
		</p>
	...
	<section class="signup" style="margin-top: 30px;">
		<div class="container" style="padding-bottom: 0px; height: 360px;">
			<div class="signup-content">
				<div class="signup-form" style="margin-top: 7%;">
					<h2 class="form-title"
						style="margin-bottom: 15px !important; font-size: 26px;">Eliminar Libro</h2>
					<form action="AdminDeleteBookDatos.php" method="POST"
						...
						<div class="form-group form-button">
							<input type="submit" name="botonDelete" id="signup"
								class="form-submit" value="Eliminar"
				...
				<div class="signup-image" style="margin-top: 0px!important;">
					<figure>
