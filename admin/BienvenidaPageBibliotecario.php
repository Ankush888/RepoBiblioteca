...
<html>
    <head>
        <meta charset="UTF-8">
        <title> Home Admin - BookHouse</title>
    ...
    <body style="background: #f8f8f8 !important;">
        ...
        if (isset($_POST["botonEntrar"])) {
            ...
            if (isset($_POST["datoUsuarioNombre"]) && isset($_POST["pass"])) {
                ...
                $ejecutarQuery = mysqli_query($conn, "SELECT * FROM usuario WHERE nombreUsuario = 'bibliotecario'");
                ...
                if (password_verify($infoPassword, $hash)) {
                    ...
                    echo "<script type='text/javascript'> alert('Usuario o contraseña incorrecta.'); window.location.href='MainAdmin.php';</script>";
                }
            }
        }
        ?>

        <p id="socialmedia" style='margin-left: 0%;font-size: x-large;color: black;'> <?php echo "Admin: " . $_SESSION["loggeado"]; ?>
            <a href="https://www.facebook.com/" target="_blank"><img id="imgsContact" src="../imgs/ImgFacebook.png" alt="Facebook" style="margin-left: 26%;"></a>
